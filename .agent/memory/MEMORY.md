...
- [project] Phase 0 to Phase 10 / 10b (GPU presentation, DAG Runtime, Python 3 Embed, TexOp Pipeline, Studio Editor UI, Project System & Components, ChanOp SIMD Audio/Channels, DataOps & Scripting, Geometry Engine & 3D Vulkan Render Pipeline, Media I/O & Projection Mapping Suite, 90/90 tests) COMPLETE -> STATUS.md
- [project] Active Phase: Phase 11 (Protocols & Show Control: MIDI, OSC, Serial, DMX/Art-Net, Keyboard/Mouse) -> STATUS.md
