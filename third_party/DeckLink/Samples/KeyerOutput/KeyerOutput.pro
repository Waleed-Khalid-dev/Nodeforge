...
lessThan(QT_MAJOR_VERSION, 5):error("KeyerOutput SDK sample requires Qt5")
equals(QT_MAJOR_VERSION, 5):lessThan(QT_MINOR_VERSION, 7):error("The KeyerOutput SDK sample requires at least Qt version 5.7")
...
unix:!mac:LIBS += -ldl
win32:LIBS += -lole32 -lopengl32 -loleaut32
...
HEADERS 	+=	KeyerOutput.h \
				DeckLinkKeyerDevice.h \
				ImageBuffer.h \
				KeyerOutputEvents.h \
				com_ptr.h \
				com_utils.h \
...
FORMS 		+= 	KeyerOutput.ui

RESOURCES = KeyerOutput.qrc
