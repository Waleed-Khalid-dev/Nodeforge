...
{
	HRESULT result = CoCreateInstance(CLSID_CDeckLinkGL3ScreenPreviewHelper, nullptr, CLSCTX_ALL, IID_IDeckLinkGLScreenPreviewHelper, (void**)m_deckLinkScreenPreviewHelper.releaseAndGetAddressOf());
	if (FAILED(result))
	{
		throw std::runtime_error("A DeckLink OpenGL screen preview helper interface could not be created.");
	}
