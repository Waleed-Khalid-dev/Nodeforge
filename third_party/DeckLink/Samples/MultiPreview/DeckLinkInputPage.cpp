...
namespace
{
	...
	const std::vector<std::pair<BMDVideoConnection, QString>> kVideoInputConnections =
	{
		...
		std::make_pair(bmdVideoConnectionEthernet,		QString("Ethernet")),
		std::make_pair(bmdVideoConnectionOpticalEthernet,		QString("Optical Ethernet")),
	};
...
void DeckLinkInputPage::selectedDeviceChanged(void)
{
	...
	QString title = QString("Input %1: %2%3").arg(pageIndex).arg(m_deviceListCombo->itemText(indexToSelect)).arg(active ? "" : " [inactive]");
