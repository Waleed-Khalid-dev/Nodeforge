...
macx:LIBS += -framework CoreFoundation -framework Cocoa -framework Metal -framework MetalKit
unix:!mac:LIBS += -ldl
...
HEADERS += \
        ...
        platform.h \
        com_ptr.h \
        MultiPreviewEvents.h \
        DeckLinkInputPage.h

mac {
        HEADERS +=  DeckLinkMetalMultiViewWidget.h \
                    DeckLinkPreviewWidget.h
        SOURCES +=  DeckLinkMetalMultiViewWidget.mm \
                    DeckLinkPreviewWidget.cpp
} else {
        HEADERS += DeckLinkOpenGLWidget.h
        SOURCES += DeckLinkOpenGLWidget.cpp
}
